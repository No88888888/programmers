...
(select *, '단기대여' from CAR_RENTAL_COMPANY_RENTAL_HISTORY
where start_date > '2022-08-31' and
DATEDIFF(DAY, start_date, end_date) < 30)
UNION
(select *, '장기대여' from CAR_RENTAL_COMPANY_RENTAL_HISTORY
where start_date > '2022-08-31' and
DATEDIFF(DAY, start_date, end_date) >= 30)
